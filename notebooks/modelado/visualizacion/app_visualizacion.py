...
st.write("#### Persona: Selva Lorena Orias Huaylla")
st.write("----")
...
#grafico adicional
fig2 = px.histogram(df, x="importe_solicitado", y="edad", color="genero", hover_data=df.columns, title="Importes solicitados por edad y género")
fig2.update_layout(xaxis_title='Importe solicitado', yaxis_title='Edad')
